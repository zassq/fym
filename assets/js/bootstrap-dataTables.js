...
$.extend(true, $.fn.dataTable.defaults, {
    ...
    "fnInitComplete": function (oSettings, json) {
        ...
        if (currentId) {
            ...
            thisLengthLabel.addClass('control-label col-xs-6 col-sm-9 col-md-10').attr('for', currentId + '_length_select').css('text-align', 'left');
            thisLengthSelect.addClass('form-control input-sm').attr('id', currentId + '_length_select');
            thisLengthSelect.prependTo(thisLength).wrap('<div class="col-xs-6 col-sm-3 col-md-2" />');
